...
const Projects = () => {
  return (
    <div className="container py-5">
      <h2 className="text-center mb-4 text-light">Proyectos Destacados</h2>
          ...
          <div className="col-lg-6">
            <div className="card-body p-4">
              <div className="d-flex align-items-center mb-2">
                ...
                <small className="text-muted">Desarrollo Grupal</small>
              </div>

              <h3 className="card-title text-white fw-bold">
                El Veinticinco - Gestión de Alquileres de Fútbol 5
              </h3>

              <p className="card-text text-light opacity-75 mt-3">
                Plataforma full stack para la reserva de canchas y turnos de
                fútbol 5. Incluye autenticación segura, cifrado de credenciales
                y un panel dinámico para usuarios y administradores.
              </p>
              ...
              <div className="mb-4">
                ...
                <div className="d-flex flex-wrap gap-2">
                  ...
                  <span className='badge bg-primary text-white'>MercadoLibre</span>
                </div>
              </div>
              ...
              <div className="d-flex gap-3">
                ...
                <a href="https://elveinticincoalquilercanchasfutbol.netlify.app/">
                 ...
                 <a
                  href="https://github.com/Pablo-German-Jimenez/elveinticinco-backend-alquiler-canchas"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn btn-outline-light btn-sm d-flex align-items-center gap-2"
                >
        ...
        <div className="row g-0 align-items-center">
          ...
          <div className="col-lg-6">
            <div className="card-body p-4">
              ...
              <h3 className="card-title text-white fw-bold">
                Cancheros - Gestión de Alquileres de Fútbol 5
              </h3>
