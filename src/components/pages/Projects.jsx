          ...
          <div className="col-lg-6">
            <div className="card-body p-4">
              <h3 className="card-title text-white fw-bold">
                Bakery contability diary
              </h3>
              <p className="card-text text-light opacity-75 mt-3">
                An application that saves the time of manually recording sales,
                inspired by a neighborhood bakery, allowing you to see sales in
                real time, and when collecting payment, it is stored in an
                internal list, which when consulted shows the details, ideal for
                streamlining the management of an accounting journal.
              </p>
              <div className="mb-4">
              ...
              <div className="d-flex gap-3">
                <a
                  href="https://github.com/Pablo-German-Jimenez/backery-contability-backend-with-pipeline-ci-cd"
                  target="_blank"
                ...
                <a
                  href="https://github.com/Pablo-German-Jimenez/bakery-product-contability-frontend-with-pipeline-ci-cd"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn btn-outline-light btn-sm d-flex align-items-center gap-2"
                >
                ...
                <a href="https://bakery-accounting-book.netlify.app/">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
        ...
        <div className="row g-0 align-items-center">
          ...
          <div className="col-lg-6">
            <div className="card-body p-4">
              ...
              <p className="card-text text-light opacity-75 mt-3">
                Platform for booking socced fields and time slots, includes
                secure authentification, credential encrypton, and a dynamic
                dashboard for users and administrations.
              </p>
              <div className="mb-4">
                <h6 className="text-uppercase text-muted fs-7 mb-2">
                  Technologies used
        ...
        <div className="row g-0 align-items-center">
          ...
          <div className="col-lg-6">
            <div className="card-body p-4">
              ...
              <p className="card-text text-light opacity-75 mt-3">
                Movie and series streaming application, with technologies such
                as bcrypt for user key security.
              </p>
              <div className="mb-4">
                <h6 className="text-uppercase text-muted fs-7 mb-2">
                  Technologies used
