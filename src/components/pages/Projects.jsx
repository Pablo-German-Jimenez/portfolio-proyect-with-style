          ...
          <div className="col-lg-6">
            <div className="card-body p-4">
              ...
              <p className="card-text text-light opacity-75 mt-3">
                Plataforma full stack M.E.R.N para la reserva de canchas y turnos de
        ...
        <div className="row g-0 align-items-center">
          ...
          <div className="col-lg-6">
            <div className="card-body p-4">
              ...
              <h3 className="card-title text-white fw-bold">
                Pixels Movies - Streaming de películas y series
              </h3>

              <p className="card-text text-light opacity-75 mt-3">
                Plataforma de streaming full stack M.E.R.N frontEnd con backEnd
              </p>
              <div className="mb-4">
                <h6 className="text-uppercase text-muted fs-7 mb-2">
                  Tecnologías Utilizadas
